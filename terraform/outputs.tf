output "hosts_file" {
  ...
  value = join("\n", [
    ...
    "${var.traefik_lb_ip} homepage.${var.domain_root} overseerr.${var.domain_root}  radarr.${var.domain_root} sonarr.${var.domain_root} transmission.${var.domain_root} yam.${var.domain_root}",
    "",
